  ...
  return (
    <div>
      ...
      <main className="max-w-4xl mx-auto px-4 py-10">
        ...
        <p className="mb-4">
          Estos términos y condiciones regulan el uso del sitio web de EKORU y los servicios ofrecidos. Al acceder o
          utilizar nuestro sitio, aceptas cumplir con estos términos.
        </p>
        <h2 className="text-2xl font-semibold mt-6 mb-2">1. Uso del sitio</h2>
        <p className="mb-4">
          Te comprometes a utilizar nuestro sitio de manera legal y respetuosa. No debes utilizarlo para actividades
          ilícitas o que infrinjan los derechos de terceros.
        </p>
        <h2 className="text-2xl font-semibold mt-6 mb-2">2. Propiedad intelectual</h2>
        <p className="mb-4">
          Todos los contenidos del sitio, incluyendo textos, imágenes y logotipos, son propiedad de EKORU o de terceros
          que han autorizado su uso. No puedes reproducir, distribuir o modificar estos contenidos sin nuestro
          consentimiento previo por escrito.
        </p>
        <h2 className="text-2xl font-semibold mt-6 mb-2">3. Limitación de responsabilidad</h2>
        <p className="mb-4">
          EKORU no se hace responsable por daños o perjuicios derivados del uso de nuestro sitio o de la imposibilidad
          de acceder al mismo.
        </p>
        ...
        <p className="mb-4">
          ...
          entrarán en vigor desde su publicación en el sitio.
        </p>
        <h2 className="text-2xl font-semibold mt-6 mb-2">5. Ley aplicable</h2>
        <p className="mb-4">
          Estos términos se rigen por las leyes de Chile. Cualquier disputa relacionada con estos términos será resuelta
          por los tribunales competentes de Santiago.
        </p>
