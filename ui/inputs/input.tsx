      ...
      <div className="relative">
        ...
        >
          ...
          <input
            ...
            required
            className={clsx(
              "w-full pl-10 pr-12 py-3 border border-gray-300 rounded-lg focus:ring-0 focus:border-primary focus:text-primary transition-all duration-200 bg-gray-50 focus:bg-white",
